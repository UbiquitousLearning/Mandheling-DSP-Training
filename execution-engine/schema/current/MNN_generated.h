...
enum OpType {
  ...
  OpType_NITI_CONV_Int8 = 700,
  OpType_NITI_DeCONV_Int8 = 701,
  OpType_NITI_Conv2DBackPropFilter_Int8 = 702,
  OpType_NITI_Relu_Int8 = 703,
  OpType_NITI_ReluGrad_Int8 = 704,
  OpType_NITI_Maxpool_Int8 = 705,
  OpType_NITI_PoolGrad_Int8 = 706,
  OpType_NITI_ELTWISE_Int8 = 707,
  OpType_NITI_SOFTMAX_Int8 = 708,
  OpType_NITI_PstoShiftInt32toInt8 = 709,
  OpType_NITI_LOSS_Int8 = 710,
  OpType_NITI_LOSS_Grad_Int8 = 711,
  OpType_NITI_SOFTMAX_Grad_Int8 = 712,
  OpType_NITI_MatMul_Int8 = 713,
  OpType_NITI_PAD_Int8 = 714,
  OpType_NITI_GradientCONV_Int8 = 715,
  OpType_NITI_ConvertChannel1NC4HW4ToNCHW_Int8 = 716,
  OpType_NITI_CONVMaxMin_Int8 = 717,
  OpType_NITI_LeftPoolGrad_Int8 = 718,
  OpType_NITI_GradientSplitCONV_Int8 = 719,
  OpType_NITI_DSP_CONV_Int8 = 800,
  OpType_NITI_DSP_RELU_Int8 = 801,
  OpType_NITI_DSP_MAXPOOL_Int8 = 802,
  OpType_NITI_DSP_RESHAPE_Int8 = 803,
  OpType_NITI_DSP_LOSSGRAD_Int8 = 804,
  OpType_NITI_DSP_RELUGRAD_Int8 = 805,
  OpType_NITI_DSP_MAXPOOLGRAD_REF_Int8 = 806,
  OpType_NITI_DSP_MAXPOOLGRAD_Int8 = 807,
  OpType_NITI_DSP_TRANSPOSE_Int8 = 808,
  OpType_NITI_DSP_WEIGHTROTATE180_REF_Int8 = 809,
  OpType_NITI_DSP_GRADIENTCONV_Int8 = 810,
  OpType_NITI_DSP_DECONV_Int8 = 811,
  OpType_NITI_DSP_PAD_Int8 = 812,
  OpType_NITI_DSP_RESHAPEGrad_Int8 = 813,
  OpType_NITI_DSP_LEFTPOOLGRAD_DECONV_Int8 = 814,
  OpType_NITI_DSP_LEFTPOOLGRAD_GRADIENT_Int8 = 815,
  OpType_NITI_DSP_BINARY_Int8 = 816,
  OpType_NITI_DSP_NOP_Int8 = 817,
  OpType_NITI_DSP_MATMUL_GRADIENT_Int8 = 818,
  OpType_NITI_DSP_MATMUL_Int8 = 819,
  OpType_NITI_DSP_PARALLEL_GRADIENTCONV_Int8 = 820,
  OpType_NITI_DSP_GRADIENT_SPLITBatchCONV_Int8 = 821,
  OpType_NITI_DSP_TRANSPOSEGRADIENT_CONV_Int8 = 822,
  OpType_NITI_End = 823,
  OpType_MIN = OpType_AbsVal,
  OpType_MAX = OpType_NITI_End
};

inline const OpType (&EnumValuesOpType())[205] {
  static const OpType values[] = {
    ...
    OpType_LayerNorm,
    OpType_GridSample,
    OpType_NITI_CONV_Int8,
    OpType_NITI_DeCONV_Int8,
    OpType_NITI_Conv2DBackPropFilter_Int8,
    OpType_NITI_Relu_Int8,
    OpType_NITI_ReluGrad_Int8,
    OpType_NITI_Maxpool_Int8,
    OpType_NITI_PoolGrad_Int8,
    OpType_NITI_ELTWISE_Int8,
    OpType_NITI_SOFTMAX_Int8,
    OpType_NITI_PstoShiftInt32toInt8,
    OpType_NITI_LOSS_Int8,
    OpType_NITI_LOSS_Grad_Int8,
    OpType_NITI_SOFTMAX_Grad_Int8,
    OpType_NITI_MatMul_Int8,
    OpType_NITI_PAD_Int8,
    OpType_NITI_GradientCONV_Int8,
    OpType_NITI_ConvertChannel1NC4HW4ToNCHW_Int8,
    OpType_NITI_CONVMaxMin_Int8,
    OpType_NITI_LeftPoolGrad_Int8,
    OpType_NITI_GradientSplitCONV_Int8,
    OpType_NITI_DSP_CONV_Int8,
    OpType_NITI_DSP_RELU_Int8,
    OpType_NITI_DSP_MAXPOOL_Int8,
    OpType_NITI_DSP_RESHAPE_Int8,
    OpType_NITI_DSP_LOSSGRAD_Int8,
    OpType_NITI_DSP_RELUGRAD_Int8,
    OpType_NITI_DSP_MAXPOOLGRAD_REF_Int8,
    OpType_NITI_DSP_MAXPOOLGRAD_Int8,
    OpType_NITI_DSP_TRANSPOSE_Int8,
    OpType_NITI_DSP_WEIGHTROTATE180_REF_Int8,
    OpType_NITI_DSP_GRADIENTCONV_Int8,
    OpType_NITI_DSP_DECONV_Int8,
    OpType_NITI_DSP_PAD_Int8,
    OpType_NITI_DSP_RESHAPEGrad_Int8,
    OpType_NITI_DSP_LEFTPOOLGRAD_DECONV_Int8,
    OpType_NITI_DSP_LEFTPOOLGRAD_GRADIENT_Int8,
    OpType_NITI_DSP_BINARY_Int8,
    OpType_NITI_DSP_NOP_Int8,
    OpType_NITI_DSP_MATMUL_GRADIENT_Int8,
    OpType_NITI_DSP_MATMUL_Int8,
    OpType_NITI_DSP_PARALLEL_GRADIENTCONV_Int8,
    OpType_NITI_DSP_GRADIENT_SPLITBatchCONV_Int8,
    OpType_NITI_DSP_TRANSPOSEGRADIENT_CONV_Int8,
    OpType_NITI_End
  };
  return values;
}
...
inline const char *EnumNameOpType(OpType e) {
  if (e < OpType_AbsVal || e > OpType_NITI_End) return "";
...
enum OpParameter {
  ...
  OpParameter_NITI_CONV_Int8 = 93,
  OpParameter_NITI_Relu_Int8 = 94,
  OpParameter_NITI_Pool_Int8 = 95,
  OpParameter_NITI_ELTWISE_Int8 = 96,
  OpParameter_NITI_LOSS_Int8 = 97,
  OpParameter_NITI_PAD_Int8 = 98,
  OpParameter_MIN = OpParameter_NONE,
  OpParameter_MAX = OpParameter_NITI_PAD_Int8
};
...
inline const OpParameter (&EnumValuesOpParameter())[99] {
  static const OpParameter values[] = {
    ...
    OpParameter_NITI_CONV_Int8,
    OpParameter_NITI_Relu_Int8,
    OpParameter_NITI_Pool_Int8,
    OpParameter_NITI_ELTWISE_Int8,
    OpParameter_NITI_LOSS_Int8,
    OpParameter_NITI_PAD_Int8
  };
  return values;
}
...
inline const char *EnumNameOpParameter(OpParameter e) {
  if (e < OpParameter_NONE || e > OpParameter_NITI_PAD_Int8) return "";
  const size_t index = static_cast<int>(e);
...
template<> struct OpParameterTraits<NITI_CONV_Int8> {
  static const OpParameter enum_value = OpParameter_NITI_CONV_Int8;
};

template<> struct OpParameterTraits<NITI_Relu_Int8> {
  static const OpParameter enum_value = OpParameter_NITI_Relu_Int8;
};

template<> struct OpParameterTraits<NITI_Pool_Int8> {
  static const OpParameter enum_value = OpParameter_NITI_Pool_Int8;
};

template<> struct OpParameterTraits<NITI_ELTWISE_Int8> {
  static const OpParameter enum_value = OpParameter_NITI_ELTWISE_Int8;
};

template<> struct OpParameterTraits<NITI_LOSS_Int8> {
  static const OpParameter enum_value = OpParameter_NITI_LOSS_Int8;
};

template<> struct OpParameterTraits<NITI_PAD_Int8> {
  static const OpParameter enum_value = OpParameter_NITI_PAD_Int8;
};
...
struct OpParameterUnion {
  ...
  NITI_CONV_Int8T *AsNITI_CONV_Int8() {
    return type == OpParameter_NITI_CONV_Int8 ?
      reinterpret_cast<NITI_CONV_Int8T *>(value) : nullptr;
  }
  const NITI_CONV_Int8T *AsNITI_CONV_Int8() const {
    return type == OpParameter_NITI_CONV_Int8 ?
      reinterpret_cast<const NITI_CONV_Int8T *>(value) : nullptr;
  }
  NITI_Relu_Int8T *AsNITI_Relu_Int8() {
    return type == OpParameter_NITI_Relu_Int8 ?
      reinterpret_cast<NITI_Relu_Int8T *>(value) : nullptr;
  }
  const NITI_Relu_Int8T *AsNITI_Relu_Int8() const {
    return type == OpParameter_NITI_Relu_Int8 ?
      reinterpret_cast<const NITI_Relu_Int8T *>(value) : nullptr;
  }
  NITI_Pool_Int8T *AsNITI_Pool_Int8() {
    return type == OpParameter_NITI_Pool_Int8 ?
      reinterpret_cast<NITI_Pool_Int8T *>(value) : nullptr;
  }
  const NITI_Pool_Int8T *AsNITI_Pool_Int8() const {
    return type == OpParameter_NITI_Pool_Int8 ?
      reinterpret_cast<const NITI_Pool_Int8T *>(value) : nullptr;
  }
  NITI_ELTWISE_Int8T *AsNITI_ELTWISE_Int8() {
    return type == OpParameter_NITI_ELTWISE_Int8 ?
      reinterpret_cast<NITI_ELTWISE_Int8T *>(value) : nullptr;
  }
  const NITI_ELTWISE_Int8T *AsNITI_ELTWISE_Int8() const {
    return type == OpParameter_NITI_ELTWISE_Int8 ?
      reinterpret_cast<const NITI_ELTWISE_Int8T *>(value) : nullptr;
  }
  NITI_LOSS_Int8T *AsNITI_LOSS_Int8() {
    return type == OpParameter_NITI_LOSS_Int8 ?
      reinterpret_cast<NITI_LOSS_Int8T *>(value) : nullptr;
  }
  const NITI_LOSS_Int8T *AsNITI_LOSS_Int8() const {
    return type == OpParameter_NITI_LOSS_Int8 ?
      reinterpret_cast<const NITI_LOSS_Int8T *>(value) : nullptr;
  }
  NITI_PAD_Int8T *AsNITI_PAD_Int8() {
    return type == OpParameter_NITI_PAD_Int8 ?
      reinterpret_cast<NITI_PAD_Int8T *>(value) : nullptr;
  }
  const NITI_PAD_Int8T *AsNITI_PAD_Int8() const {
    return type == OpParameter_NITI_PAD_Int8 ?
      reinterpret_cast<const NITI_PAD_Int8T *>(value) : nullptr;
  }
};
...
struct Op FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const NITI_CONV_Int8 *main_as_NITI_CONV_Int8() const {
    return main_type() == OpParameter_NITI_CONV_Int8 ? static_cast<const NITI_CONV_Int8 *>(main()) : nullptr;
  }
  const NITI_Relu_Int8 *main_as_NITI_Relu_Int8() const {
    return main_type() == OpParameter_NITI_Relu_Int8 ? static_cast<const NITI_Relu_Int8 *>(main()) : nullptr;
  }
  const NITI_Pool_Int8 *main_as_NITI_Pool_Int8() const {
    return main_type() == OpParameter_NITI_Pool_Int8 ? static_cast<const NITI_Pool_Int8 *>(main()) : nullptr;
  }
  const NITI_ELTWISE_Int8 *main_as_NITI_ELTWISE_Int8() const {
    return main_type() == OpParameter_NITI_ELTWISE_Int8 ? static_cast<const NITI_ELTWISE_Int8 *>(main()) : nullptr;
  }
  const NITI_LOSS_Int8 *main_as_NITI_LOSS_Int8() const {
    return main_type() == OpParameter_NITI_LOSS_Int8 ? static_cast<const NITI_LOSS_Int8 *>(main()) : nullptr;
  }
  const NITI_PAD_Int8 *main_as_NITI_PAD_Int8() const {
    return main_type() == OpParameter_NITI_PAD_Int8 ? static_cast<const NITI_PAD_Int8 *>(main()) : nullptr;
  }
...
template<> inline const NITI_CONV_Int8 *Op::main_as<NITI_CONV_Int8>() const {
  return main_as_NITI_CONV_Int8();
}

template<> inline const NITI_Relu_Int8 *Op::main_as<NITI_Relu_Int8>() const {
  return main_as_NITI_Relu_Int8();
}

template<> inline const NITI_Pool_Int8 *Op::main_as<NITI_Pool_Int8>() const {
  return main_as_NITI_Pool_Int8();
}

template<> inline const NITI_ELTWISE_Int8 *Op::main_as<NITI_ELTWISE_Int8>() const {
  return main_as_NITI_ELTWISE_Int8();
}

template<> inline const NITI_LOSS_Int8 *Op::main_as<NITI_LOSS_Int8>() const {
  return main_as_NITI_LOSS_Int8();
}

template<> inline const NITI_PAD_Int8 *Op::main_as<NITI_PAD_Int8>() const {
  return main_as_NITI_PAD_Int8();
}
...
inline bool VerifyOpParameter(flatbuffers::Verifier &verifier, const void *obj, OpParameter type) {
  switch (type) {
    ...
    case OpParameter_NITI_CONV_Int8: {
      auto ptr = reinterpret_cast<const NITI_CONV_Int8 *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case OpParameter_NITI_Relu_Int8: {
      auto ptr = reinterpret_cast<const NITI_Relu_Int8 *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case OpParameter_NITI_Pool_Int8: {
      auto ptr = reinterpret_cast<const NITI_Pool_Int8 *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case OpParameter_NITI_ELTWISE_Int8: {
      auto ptr = reinterpret_cast<const NITI_ELTWISE_Int8 *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case OpParameter_NITI_LOSS_Int8: {
      auto ptr = reinterpret_cast<const NITI_LOSS_Int8 *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case OpParameter_NITI_PAD_Int8: {
      auto ptr = reinterpret_cast<const NITI_PAD_Int8 *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline flatbuffers::Offset<void> OpParameterUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    ...
    case OpParameter_NITI_CONV_Int8: {
      auto ptr = reinterpret_cast<const NITI_CONV_Int8T *>(value);
      return CreateNITI_CONV_Int8(_fbb, ptr, _rehasher).Union();
    }
    case OpParameter_NITI_Relu_Int8: {
      auto ptr = reinterpret_cast<const NITI_Relu_Int8T *>(value);
      return CreateNITI_Relu_Int8(_fbb, ptr, _rehasher).Union();
    }
    case OpParameter_NITI_Pool_Int8: {
      auto ptr = reinterpret_cast<const NITI_Pool_Int8T *>(value);
      return CreateNITI_Pool_Int8(_fbb, ptr, _rehasher).Union();
    }
    case OpParameter_NITI_ELTWISE_Int8: {
      auto ptr = reinterpret_cast<const NITI_ELTWISE_Int8T *>(value);
      return CreateNITI_ELTWISE_Int8(_fbb, ptr, _rehasher).Union();
    }
    case OpParameter_NITI_LOSS_Int8: {
      auto ptr = reinterpret_cast<const NITI_LOSS_Int8T *>(value);
      return CreateNITI_LOSS_Int8(_fbb, ptr, _rehasher).Union();
    }
    case OpParameter_NITI_PAD_Int8: {
      auto ptr = reinterpret_cast<const NITI_PAD_Int8T *>(value);
      return CreateNITI_PAD_Int8(_fbb, ptr, _rehasher).Union();
    }
    default: return 0;
  }
}
...
inline OpParameterUnion::OpParameterUnion(const OpParameterUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case OpParameter_NITI_CONV_Int8: {
      FLATBUFFERS_ASSERT(false);  // NITI_CONV_Int8T not copyable.
      break;
    }
    case OpParameter_NITI_Relu_Int8: {
      value = new NITI_Relu_Int8T(*reinterpret_cast<NITI_Relu_Int8T *>(u.value));
      break;
    }
    case OpParameter_NITI_Pool_Int8: {
      value = new NITI_Pool_Int8T(*reinterpret_cast<NITI_Pool_Int8T *>(u.value));
      break;
    }
    case OpParameter_NITI_ELTWISE_Int8: {
      value = new NITI_ELTWISE_Int8T(*reinterpret_cast<NITI_ELTWISE_Int8T *>(u.value));
      break;
    }
    case OpParameter_NITI_LOSS_Int8: {
      value = new NITI_LOSS_Int8T(*reinterpret_cast<NITI_LOSS_Int8T *>(u.value));
      break;
    }
    case OpParameter_NITI_PAD_Int8: {
      value = new NITI_PAD_Int8T(*reinterpret_cast<NITI_PAD_Int8T *>(u.value));
      break;
    }
    default:
      break;
...
inline void OpParameterUnion::Reset() {
  switch (type) {
    ...
    case OpParameter_NITI_CONV_Int8: {
      auto ptr = reinterpret_cast<NITI_CONV_Int8T *>(value);
      delete ptr;
      break;
    }
    case OpParameter_NITI_Relu_Int8: {
      auto ptr = reinterpret_cast<NITI_Relu_Int8T *>(value);
      delete ptr;
      break;
    }
    case OpParameter_NITI_Pool_Int8: {
      auto ptr = reinterpret_cast<NITI_Pool_Int8T *>(value);
      delete ptr;
      break;
    }
    case OpParameter_NITI_ELTWISE_Int8: {
      auto ptr = reinterpret_cast<NITI_ELTWISE_Int8T *>(value);
      delete ptr;
      break;
    }
    case OpParameter_NITI_LOSS_Int8: {
      auto ptr = reinterpret_cast<NITI_LOSS_Int8T *>(value);
      delete ptr;
      break;
    }
    case OpParameter_NITI_PAD_Int8: {
      auto ptr = reinterpret_cast<NITI_PAD_Int8T *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline const flatbuffers::TypeTable *OpTypeTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_ENUM, 205, type_codes, type_refs, values, names
  };
  return &tt;
}
...
inline const flatbuffers::TypeTable *OpParameterTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    ...
    GridSampleTypeTable,
    LoopParamTypeTable,
    NITI_CONV_Int8TypeTable,
    NITI_Relu_Int8TypeTable,
    NITI_Pool_Int8TypeTable,
    NITI_ELTWISE_Int8TypeTable,
    NITI_LOSS_Int8TypeTable,
    NITI_PAD_Int8TypeTable
  };
  static const char * const names[] = {
    "NONE",
    "QuantizedAdd",
