//
//  NITI_GradientSplitConv_Int8.hpp
//  MNN
//
//  Created by xudaliang on 2022/1/17.
//  
//

#ifndef NITI_GradientSplitConv_Int8_hpp
#define NITI_GradientSplitConv_Int8_hpp
...
class NITI_GradientSplitConv_Int8 : public CPUConvolution {
public:
    
    NITI_GradientSplitConv_Int8(Backend *backend, const NITI_CONV_Int8* common);
    virtual ~NITI_GradientSplitConv_Int8();
...
private:
    ...
    std::shared_ptr<Tensor> splitWeight;
...
#endif /* NITI_GradientSplitConv_Int8_hpp */
