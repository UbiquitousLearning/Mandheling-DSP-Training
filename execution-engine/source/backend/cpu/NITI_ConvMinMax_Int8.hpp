...
#ifndef NITI_ConvMinMax_Int8_hpp
#define NITI_ConvMinMax_Int8_hpp
...
class NITI_ConvMinMax_Int8 : public CPUConvolution {
public:
    
    NITI_ConvMinMax_Int8(Backend *backend, const NITI_CONV_Int8* common);
    virtual ~NITI_ConvMinMax_Int8();
...
#endif /* NITI_ConvMinMax_Int8_hpp */
