...
#ifndef NITI_DSPGradientConv_Int8_hpp
#define NITI_DSPGradientConv_Int8_hpp
...
class NITI_DSPGradientConv_Int8 : public CPUConvolution {
public:
    
    NITI_DSPGradientConv_Int8(Backend *backend, const NITI_CONV_Int8* common,  const MNN::Op* op);
    virtual ~NITI_DSPGradientConv_Int8();
