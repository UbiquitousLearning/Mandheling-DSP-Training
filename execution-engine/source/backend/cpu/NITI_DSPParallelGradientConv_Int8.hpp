//
//  NITI_DSPParallelGradientConv_Int8.hpp
//  MNN
//
...
#ifndef NITI_DSPParallelGradientConv_Int8_hpp
#define NITI_DSPParallelGradientConv_Int8_hpp
...
class NITI_DSPParallelGradientConv_Int8 : public CPUConvolution {
public:
    
    NITI_DSPParallelGradientConv_Int8(Backend *backend, const NITI_CONV_Int8* common,  const MNN::Op* op);
    virtual ~NITI_DSPParallelGradientConv_Int8();
...
#endif /* NITI_DSPParallelGradientConv_Int8_hpp */
