...
#ifndef NITI_DSPReshapeGrad_Int8_hpp
#define NITI_DSPReshapeGrad_Int8_hpp
...
namespace MNN {
class NITI_DSPReshapeGrad_Int8 : public Execution {
public:
    NITI_DSPReshapeGrad_Int8(Backend *b, const MNN::Op* op);
    virtual ~NITI_DSPReshapeGrad_Int8() = default;
...
#endif /* NITI_DSPReshapeGrad_Int8_hpp */
