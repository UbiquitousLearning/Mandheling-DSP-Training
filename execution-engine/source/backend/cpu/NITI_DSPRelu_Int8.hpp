...
#ifndef NITI_DSPRelu_Int8_hpp
#define NITI_DSPRelu_Int8_hpp
...
namespace MNN {
class NITI_DSPRelu_Int8 : public Execution {
public:
    NITI_DSPRelu_Int8(Backend *b);
    virtual ~NITI_DSPRelu_Int8() = default;
