...
#ifndef NITI_DSPBinary_Int8_hpp
#define NITI_DSPBinary_Int8_hpp
...
namespace MNN {
class NITI_DSPBinary_Int8 : public Execution {
public:
    NITI_DSPBinary_Int8(Backend *b, const MNN::Op *op);
    virtual ~NITI_DSPBinary_Int8() = default;
...
private:
    ...
    std::shared_ptr<Tensor> input2UINT8Tensor;
