...
#ifndef NITI_DSPDeConv_Int8_hpp
#define NITI_DSPDeConv_Int8_hpp
...
class NITI_DSPDeConv_Int8 : public CPUConvolution {
public:
    
    NITI_DSPDeConv_Int8(Backend *backend, const NITI_CONV_Int8* common,  const MNN::Op* op);
    virtual ~NITI_DSPDeConv_Int8();
...
private:
    ...
    // 此处padvalue为128，是因为这个paduint8的值，需要加上128
