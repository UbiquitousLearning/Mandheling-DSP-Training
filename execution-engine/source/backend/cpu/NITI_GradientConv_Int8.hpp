...
#ifndef NITI_GradientConv_Int8_hpp
#define NITI_GradientConv_Int8_hpp
...
class NITI_GradientConv_Int8 : public CPUConvolution {
public:
    
    NITI_GradientConv_Int8(Backend *backend, const NITI_CONV_Int8* common);
    virtual ~NITI_GradientConv_Int8();
...
#endif /* NITI_GradientConv_Int8_hpp */
