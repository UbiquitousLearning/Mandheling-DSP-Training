...
public:
    ...
    virtual void DSPExecute() {}
    virtual void DSPParallelWait() {}
    virtual bool isDSPParallel() {return false;}
    virtual int get_Op_id(Tensor* t, MNN::OpType type) {  printf("error backend\n"); exit(-1); }
    virtual void insert_Op_id(Tensor* t, int op_id) {  printf("error backend\n"); exit(-1); }
