...
MNN_PUBLIC Express::VARP _NITI_LOSS_CrossEntropy(Express::VARP predicts, Express::VARP ascale, Express::VARP oneHotTargets);
MNN_PUBLIC Express::VARP _NITI_CrossEntropy(Express::VARP predicts, Express::VARP oneHotTargets);
MNN_PUBLIC Express::VARP _NITI_CrossEntropy_FAKE(Express::VARP predicts, Express::VARP oneHotTargets);
