...
public:
    ...
    static Module* NITI_Conv_Int8(const ConvOption& option, int bits = 8, bool isFC = false, bool bias = true,
                                            std::shared_ptr<Initializer> weightInit = nullptr,
                                            std::shared_ptr<Initializer> ascaleInit   = nullptr,
                                            std::shared_ptr<Initializer> wscaleInit  = nullptr,
                                            FeatureScaleStatMethod featureMethod = PerChannel,
                                            ScaleUpdateMethod method = MovingAverage
                                            ); 
    static Module* NITI_DSP_Conv_Int8(const ConvOption& option, int bits = 8, bool isFC = false, bool bias = true,
                                            std::shared_ptr<Initializer> weightInit = nullptr,
                                            std::shared_ptr<Initializer> ascaleInit   = nullptr,
                                            std::shared_ptr<Initializer> wscaleInit  = nullptr,
                                            FeatureScaleStatMethod featureMethod = PerChannel,
    ...
    struct NITI_Conv_Int8_Parameters {
        ConvOption option;
        Express::VARP weight;
        int8_t wscale;
        int group;
    ...
    static Module* ConvInt8(const ConvParameters& parameters, int bits,
                                            FeatureScaleStatMethod featureMethod = PerChannel,
                                            ScaleUpdateMethod method = MovingAverage);
    static Module* NITI_Conv_Int8(const NITI_Conv_Int8_Parameters& parameters, int bits, bool isFC = false,
                                            FeatureScaleStatMethod featureMethod = PerChannel,
                                            ScaleUpdateMethod method = MovingAverage);
    static Module* NITI_DSP_Conv_Int8(const NITI_Conv_Int8_Parameters& parameters, int bits, bool isFC = false,
                                            FeatureScaleStatMethod featureMethod = PerChannel,
                                            ScaleUpdateMethod method = MovingAverage);
