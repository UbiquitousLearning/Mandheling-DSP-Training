#ifndef _HEXAGON_NN_DOMAINS_SKEL_H
#define _HEXAGON_NN_DOMAINS_SKEL_H
...
extern "C" {
#endif
static __inline int _skel_method(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, const char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in1, *_in2, *_in3));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_1(int (*_pfn)(remote_handle64, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   int _in1[1];
   uint32_t* _primIn;
   ...
   _COPY(_in0, 0, _primIn, 0, 4);
   _COPY(_in1, 0, _primIn, 4, 4);
   _TRY(_nErr, _pfn(_h, *_in1));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_2(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int*, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   hexagon_nn_nn_id _in1[1];
   ...
   _COPY(_in0, 0, _primIn, 0, 4);
   _COPY(_in1, 0, _primIn, 4, 4);
   _TRY(_nErr, _pfn(_h, *_in1, _rout2, _rout3));
   _COPY(_primROut, 0, _rout2, 0, 4);
   _COPY(_primROut, 4, _rout3, 0, 4);
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_3(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, hexagon_nn_nn_id, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   hexagon_nn_nn_id _in1[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in1, *_in2, _rout3));
   _COPY(_primROut, 0, _rout3, 0, 4);
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_4(int (*_pfn)(remote_handle64, hexagon_nn_nn_id*, const hexagon_nn_initinfo*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   ...
   _TRY(_nErr, _pfn(_h, _rout1, _in2));
...
static __inline int _skel_method_5(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, const hexagon_nn_tensordef*, int, hexagon_nn_tensordef*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   hexagon_nn_nn_id _in1[1];
   const hexagon_nn_tensordef* _in2[1];
   int _in2Len[1];
   hexagon_nn_tensordef* _rout3[1];
   int _rout3Len[1];
   uint32_t* _primIn;
   int _numIn[1];
   int _numInH[1];
   ...
   _ASSERT(_nErr, ((_praIn[0].buf.nLen / 28)) >= (size_t)(_in2Len[0]));
   _ALLOCATE(_nErr, _al, (_in2Len[0] * SLIM_IFPTR32(32, 40)), SLIM_IFPTR32(4, 8), _in2[0]);
   ...
   {
      _TRY(_nErr, _skel_unpack_3(_al, (_praIn + 1), _ppraIn, (_praROut + 0), _ppraROut, _praHIn, _ppraHIn, _praHROut, _ppraHROut, _seq_primIn2, 0, SLIM_IFPTR32((const hexagon_nn_tensordef*)&(((uint32_t*)_seq_nat2)[0]), (const hexagon_nn_tensordef*)&(((uint64_t*)_seq_nat2)[0]))));
   }
   _COPY(_rout3Len, 0, _primIn, 12, 4);
   _ASSERT(_nErr, ((_praIn[1].buf.nLen / 4)) >= (size_t)(_rout3Len[0]));
   _ASSERT(_nErr, ((_praROut[0].buf.nLen / 24)) >= (size_t)(_rout3Len[0]));
   _ALLOCATE(_nErr, _al, (_rout3Len[0] * SLIM_IFPTR32(32, 40)), SLIM_IFPTR32(4, 8), _rout3[0]);
   ...
   {
      _TRY(_nErr, _skel_unpack_1(_al, (_praIn + 2), _ppraIn, (_praROut + 1), _ppraROut, _praHIn, _ppraHIn, _praHROut, _ppraHROut, _seq_primIn3, _seq_primROut3, SLIM_IFPTR32((hexagon_nn_tensordef*)&(((uint32_t*)_seq_nat3)[0]), (hexagon_nn_tensordef*)&(((uint64_t*)_seq_nat3)[0]))));
   }
   _TRY(_nErr, _pfn(_h, *_in1, *_in2, *_in2Len, *_rout3, *_rout3Len));
   for(_ii = 0, _seq_nat2 = (char*)_in2[0];_ii < (int)_in2Len[0];++_ii, _seq_nat2 = (_seq_nat2 + SLIM_IFPTR32(32, 40)))
   {
      _TRY(_nErr, _skel_pack_2((_praROutPost + 0), _ppraROutPost, 0, SLIM_IFPTR32((const hexagon_nn_tensordef*)&(((uint32_t*)_seq_nat2)[0]), (const hexagon_nn_tensordef*)&(((uint64_t*)_seq_nat2)[0]))));
   }
   ...
   {
      _TRY(_nErr, _skel_pack_1((_praROutPost + 1), _ppraROutPost, _seq_primROut3, SLIM_IFPTR32((hexagon_nn_tensordef*)&(((uint32_t*)_seq_nat3)[0]), (hexagon_nn_tensordef*)&(((uint64_t*)_seq_nat3)[0]))));
   }
   _CATCH(_nErr) {}
   _allocator_deinit(_al);
   return _nErr;
}
static __inline int _skel_method_6(int (*_pfn)(remote_handle64, const unsigned char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in1, *_in1Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_handle_invoke(remote_handle64 _h, uint32_t _mid, uint32_t _sc, remote_arg* _pra) {
   switch(_mid)
   {
      case 31:
      return _skel_method_6((void*)__QAIC_IMPL(hexagon_nn_domains_PrintLog), _h, _sc, _pra);
      case 32:
      return _skel_method_5((void*)__QAIC_IMPL(hexagon_nn_domains_execute_new), _h, _sc, _pra);
      case 33:
      return _skel_method_4((void*)__QAIC_IMPL(hexagon_nn_domains_init_with_info), _h, _sc, _pra);
      case 34:
      return _skel_method_3((void*)__QAIC_IMPL(hexagon_nn_domains_get_nodetype), _h, _sc, _pra);
      case 35:
      return _skel_method_2((void*)__QAIC_IMPL(hexagon_nn_domains_multi_execution_cycles), _h, _sc, _pra);
      case 36:
      return _skel_method_1((void*)__QAIC_IMPL(hexagon_nn_domains_get_power), _h, _sc, _pra);
      case 37:
      return _skel_method((void*)__QAIC_IMPL(hexagon_nn_domains_set_graph_option), _h, _sc, _pra);
   }
   return AEE_EUNSUPPORTED;
}
static __inline int _skel_method_7(int (*_pfn)(remote_handle64, int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   int _rout0[1];
   uint32_t* _primROut;
   int _numIn[1];
   ...
   _TRY(_nErr, _pfn(_h, _rout0));
   _COPY(_primROut, 0, _rout0, 0, 4);
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_8(int (*_pfn)(remote_handle64), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   int _nErr = 0;
   _praEnd = ((_pra + REMOTE_SCALARS_INBUFS(_sc)) + REMOTE_SCALARS_OUTBUFS(_sc) + REMOTE_SCALARS_INHANDLES(_sc) + REMOTE_SCALARS_OUTHANDLES(_sc));
...
static __inline int _skel_method_9(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   ...
   _primROut = _pra[(_numIn[0] + 1)].buf.pv;
   _COPY(_in0, 0, _primIn, 0, 4);
   _TRY(_nErr, _pfn(_h, *_in0, _rout1));
   _COPY(_primROut, 0, _rout1, 0, 4);
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_10(int (*_pfn)(remote_handle64, unsigned int, char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   unsigned int _in0[1];
   char* _rout1[1];
   int _rout1Len[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_rout1, *_rout1Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_11(int (*_pfn)(remote_handle64, const char*, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   const char* _in0[1];
   int _in0Len[1];
   unsigned int _rout1[1];
...
static __inline int _skel_method_12(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int*, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _rout1[1];
   unsigned int _rout2[1];
   ...
   _primROut = _pra[(_numIn[0] + 1)].buf.pv;
   _COPY(_in0, 0, _primIn, 0, 4);
   _TRY(_nErr, _pfn(_h, *_in0, _rout1, _rout2));
   _COPY(_primROut, 0, _rout1, 0, 4);
   _COPY(_primROut, 4, _rout2, 0, 4);
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_13(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   uint32_t* _primIn;
   ...
   _COPY(_in0, 0, _primIn, 0, 4);
   _COPY(_in1, 0, _primIn, 4, 4);
   _TRY(_nErr, _pfn(_h, *_in0, *_in1));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_14(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, hexagon_nn_perfinfo*, int, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   ...
   _rout1[0] = _praROut[0].buf.pv;
   _TRY(_nErr, _pfn(_h, *_in0, *_rout1, *_rout1Len, _rout2));
   _COPY(_primROut, 0, _rout2, 0, 4);
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_15(int (*_pfn)(remote_handle64, hexagon_nn_corner_type, hexagon_nn_dcvs_type, unsigned int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   ...
   _COPY(_in1, 0, _primIn, 4, 4);
   _COPY(_in2, 0, _primIn, 8, 4);
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_16(int (*_pfn)(remote_handle64, unsigned int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   unsigned int _in0[1];
   uint32_t* _primIn;
   int _nErr = 0;
   ...
   _primIn = _pra[0].buf.pv;
   _COPY(_in0, 0, _primIn, 0, 4);
   _TRY(_nErr, _pfn(_h, *_in0));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_17(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, int, const unsigned char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   int _in2[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, *_in3, *_in3Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_18(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, int, unsigned int, unsigned int, unsigned int, unsigned int, const unsigned char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   int _in2[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, *_in3, *_in4, *_in5, *_in6, *_in7, *_in7Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_19(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, int, unsigned int*, unsigned int*, unsigned int*, unsigned int*, unsigned char*, int, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   int _in2[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, _rout3, _rout4, _rout5, _rout6, *_rout7, *_rout7Len, _rout8));
   _COPY(_primROut, 0, _rout3, 0, 4);
...
static __inline int _skel_method_20(int (*_pfn)(remote_handle64, hexagon_nn_nn_id), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   uint32_t* _primIn;
   int _nErr = 0;
...
static __inline int _skel_method_21(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, unsigned int, unsigned int, unsigned int, const unsigned char*, int, unsigned int*, unsigned int*, unsigned int*, unsigned int*, unsigned char*, int, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   unsigned int _in2[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, *_in3, *_in4, *_in5, *_in5Len, _rout6, _rout7, _rout8, _rout9, *_rout10, *_rout10Len, _rout11));
...
static __inline int _skel_method_22(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, const unsigned char*, int, unsigned int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   ...
   _in2[0] = _praIn[0].buf.pv;
   _COPY(_in3, 0, _primIn, 12, 4);
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, *_in2Len, *_in3));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_23(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   unsigned int _in2[1];
   ...
   _COPY(_in5, 0, _primIn, 20, 4);
   _COPY(_in6, 0, _primIn, 24, 4);
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, *_in3, *_in4, *_in5, *_in6));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_24(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, const unsigned char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   unsigned int _in2[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, *_in3, *_in4, *_in5, *_in6, *_in6Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_25(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned int, unsigned int, hexagon_nn_padding_type, const hexagon_nn_input*, int, const hexagon_nn_output*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   unsigned int _in1[1];
   unsigned int _in2[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in2, *_in3, *_in4, *_in4Len, *_in5, *_in5Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_26(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, unsigned char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   const unsigned char* _in1[1];
   int _in1Len[1];
...
static __inline int _skel_method_27(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   int _in1[1];
   uint32_t* _primIn;
...
static __inline int _skel_method_28(int (*_pfn)(remote_handle64, hexagon_nn_nn_id*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
...
static __inline int _skel_method_29(int (*_pfn)(remote_handle64, unsigned int*, unsigned int*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   ...
   _primROut = _pra[(_numIn[0] + 0)].buf.pv;
   _TRY(_nErr, _pfn(_h, _rout0, _rout1));
   _COPY(_primROut, 0, _rout0, 0, 4);
   _COPY(_primROut, 4, _rout1, 0, 4);
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_30(int (*_pfn)(remote_handle64, hexagon_nn_nn_id, const hexagon_nn_uint_option*, int, const hexagon_nn_string_option*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   hexagon_nn_nn_id _in0[1];
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in1, *_in1Len, *_in2, *_in2Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_31(int (*_pfn)(remote_handle64, const hexagon_nn_uint_option*, int, const hexagon_nn_string_option*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   ...
   _TRY(_nErr, _pfn(_h, *_in0, *_in0Len, *_in1, *_in1Len));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_32(int (*_pfn)(remote_handle64), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
...
static __inline int _skel_method_33(int (*_pfn)(const char*, remote_handle64*), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   const char* _in0[1];
   int _in0Len[1];
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(hexagon_nn_domains_skel_handle_invoke)(remote_handle64 _h, uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc))
   {
      case 0:
      return _skel_method_33((void*)__QAIC_IMPL(hexagon_nn_domains_open), _sc, _pra);
      case 1:
      return _skel_method_32((void*)__QAIC_IMPL(hexagon_nn_domains_close), _sc, _pra);
      case 2:
      return _skel_method_8((void*)__QAIC_IMPL(hexagon_nn_domains_config), _h, _sc, _pra);
      case 3:
      return _skel_method_31((void*)__QAIC_IMPL(hexagon_nn_domains_config_with_options), _h, _sc, _pra);
      case 4:
      return _skel_method_30((void*)__QAIC_IMPL(hexagon_nn_domains_graph_config), _h, _sc, _pra);
      case 5:
      return _skel_method_29((void*)__QAIC_IMPL(hexagon_nn_domains_get_dsp_offset), _h, _sc, _pra);
      case 6:
      return _skel_method_28((void*)__QAIC_IMPL(hexagon_nn_domains_init), _h, _sc, _pra);
      case 7:
      return _skel_method_27((void*)__QAIC_IMPL(hexagon_nn_domains_set_debug_level), _h, _sc, _pra);
      case 8:
      return _skel_method_26((void*)__QAIC_IMPL(hexagon_nn_domains_snpprint), _h, _sc, _pra);
      case 9:
      return _skel_method_26((void*)__QAIC_IMPL(hexagon_nn_domains_getlog), _h, _sc, _pra);
      case 10:
      return _skel_method_25((void*)__QAIC_IMPL(hexagon_nn_domains_append_node), _h, _sc, _pra);
      case 11:
      return _skel_method_24((void*)__QAIC_IMPL(hexagon_nn_domains_append_const_node), _h, _sc, _pra);
      case 12:
      return _skel_method_23((void*)__QAIC_IMPL(hexagon_nn_domains_append_empty_const_node), _h, _sc, _pra);
      case 13:
      return _skel_method_22((void*)__QAIC_IMPL(hexagon_nn_domains_populate_const_node), _h, _sc, _pra);
      case 14:
      return _skel_method_20((void*)__QAIC_IMPL(hexagon_nn_domains_prepare), _h, _sc, _pra);
      case 15:
      return _skel_method_21((void*)__QAIC_IMPL(hexagon_nn_domains_execute), _h, _sc, _pra);
      case 16:
      return _skel_method_20((void*)__QAIC_IMPL(hexagon_nn_domains_teardown), _h, _sc, _pra);
      case 17:
      return _skel_method_19((void*)__QAIC_IMPL(hexagon_nn_domains_variable_read), _h, _sc, _pra);
      case 18:
      return _skel_method_18((void*)__QAIC_IMPL(hexagon_nn_domains_variable_write), _h, _sc, _pra);
      case 19:
      return _skel_method_17((void*)__QAIC_IMPL(hexagon_nn_domains_variable_write_flat), _h, _sc, _pra);
      case 20:
      return _skel_method_16((void*)__QAIC_IMPL(hexagon_nn_domains_set_powersave_level), _h, _sc, _pra);
      case 21:
      return _skel_method_15((void*)__QAIC_IMPL(hexagon_nn_domains_set_powersave_details), _h, _sc, _pra);
      case 22:
      return _skel_method_14((void*)__QAIC_IMPL(hexagon_nn_domains_get_perfinfo), _h, _sc, _pra);
      case 23:
      return _skel_method_13((void*)__QAIC_IMPL(hexagon_nn_domains_reset_perfinfo), _h, _sc, _pra);
      case 24:
      return _skel_method_12((void*)__QAIC_IMPL(hexagon_nn_domains_last_execution_cycles), _h, _sc, _pra);
      case 25:
      return _skel_method_7((void*)__QAIC_IMPL(hexagon_nn_domains_version), _h, _sc, _pra);
      case 26:
      return _skel_method_11((void*)__QAIC_IMPL(hexagon_nn_domains_op_name_to_id), _h, _sc, _pra);
      case 27:
      return _skel_method_10((void*)__QAIC_IMPL(hexagon_nn_domains_op_id_to_name), _h, _sc, _pra);
      case 28:
      return _skel_method_9((void*)__QAIC_IMPL(hexagon_nn_domains_get_num_nodes_in_graph), _h, _sc, _pra);
      case 29:
      return _skel_method_8((void*)__QAIC_IMPL(hexagon_nn_domains_disable_dcvs), _h, _sc, _pra);
      case 30:
      return _skel_method_7((void*)__QAIC_IMPL(hexagon_nn_domains_GetHexagonBinaryVersion), _h, _sc, _pra);
      case 31:
      {
         uint32_t* _mid;
         if(REMOTE_SCALARS_INBUFS(_sc) < 1 || _pra[0].buf.nLen < 4) { return AEE_EBADPARM; }
         _mid = (uint32_t*)_pra[0].buf.pv;
         return _skel_handle_invoke(_h, *_mid, _sc, _pra);
      }
   }
   return AEE_EUNSUPPORTED;
}
...
#endif
#endif //_HEXAGON_NN_DOMAINS_SKEL_H
